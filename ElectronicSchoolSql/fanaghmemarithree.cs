...
{
    public partial class fanaghmemarithree : Form
    {
        const string XMLDOCFILEPAONE = "fatreenaghshehajmmarket.xml";
        XDocument doc;

        public fanaghmemarithree()
        {
            InitializeComponent();
        }

        private void fanaghmemarithree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
