...
{
    public partial class fathreenaghsheocs : Form
    {
        const string XMLDOCFILEPAONE = "fatreenaghshekeshiomoandazegiri.xml";
        XDocument doc;

        public fathreenaghsheocs()
        {
            InitializeComponent();
        }

        private void fathreenaghsheocs_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
