...
{
    public partial class narifithree : Form
    {
        const string XMLDOCFILEPAONE = "nazaritreehendesetwo.xml";
        const string XMLDOCFILEPATWO = "nazaritreejabr.xml";
      
        const string XMLDOCFILEPAFURE = "nazaritreeshimiaztree.xml";
        XDocument doc;
        ...
        private void narifithree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
