...
{
    public partial class classtwo : Form
    {
        const string XMLDOCFILEPATBE = "dbtbe.xml";
        const string XMLDOCFILEPATR = "dbtr.xml";
        const string XMLDOCFILEPATO = "dbto.xml";
        const string XMLDOCFILEPATB = "dbtb.xml";
        XDocument doc;
        ...
        private void classtwo_Load(object sender, EventArgs e)
        {
            RefreshXDoc();
        }
