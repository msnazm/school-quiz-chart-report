...
{
    public partial class pishrifi : Form
    {
        const string XMLDOCFILEPAONE = "pishrififizik.xml";
        const string XMLDOCFILEPATWO = "pishrifishimi.xml";
        const string XMLDOCFILEPATHREE = "pishrifihentjabr.xml";
        const string XMLDOCFILEPAFURE = "pishrifirigo.xml";
        XDocument doc;
        ...
        private void pishrifi_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
