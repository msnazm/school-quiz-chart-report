...
{
    public partial class facomthreecs : Form
    {
        const string XMLDOCFILEPAONE = "fatreebastenarm.xml";
        const string XMLDOCFILEPATWO = "fatreesakhtafzar.xml";
        const string XMLDOCFILEPATHREE = "fatreeshabakecom.xml";
        XDocument doc;
        ...
        private void facomthreecs_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
