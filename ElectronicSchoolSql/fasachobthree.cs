...
{
    public partial class fasachobthree : Form
    {
        const string XMLDOCFILEPAONE = "fatreesanachob.xml";
        XDocument doc;

        public fasachobthree()
        {
            InitializeComponent();
        }

        private void fasachobthree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
