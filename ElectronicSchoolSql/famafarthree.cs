...
{
    public partial class famafarthree : Form
    {
        const string XMLDOCFILEPAONE = "fatreeasarfarhangihennoghoz.xml";
        XDocument doc;
        ...
        private void famafarthree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
