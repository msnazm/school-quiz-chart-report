...
{
    public partial class faelthree : Form
    {
        const string XMLDOCFILEPAONE = "fatreemabanidijital.xml";
        const string XMLDOCFILEPATWO = "fatreemadarelecteriki.xml";
        ...
        private void faelthree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
    }
