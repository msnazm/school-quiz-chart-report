...
{
    public partial class pishta : Form
    {
        const string XMLDOCFILEPAONE = "pishtarionetwo.xml";
        const string XMLDOCFILEPATWO = "pishtazist.xml";
        XDocument doc;
        ...
        private void pishta_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
