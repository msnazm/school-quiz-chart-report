...
{
    public partial class faeltectwo : Form
    {
        const string XMLDOCFILEPAONE = "faelectrotecnictwokargahsimone.xml";
        const string XMLDOCFILEPATWO = "faelectrotecnictwokargahsimtwo.xml";
        const string XMLDOCFILEPATHREE = "famabanibargh.xml";
        XDocument doc;
        ...
        private void faeltectwo_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
