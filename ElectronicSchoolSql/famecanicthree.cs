...
{
    public partial class famecanicthree : Form
    {
        const string XMLDOCFILEPAONE = "fatreeajzamashin.xml";
        const string XMLDOCFILEPATWO = "fatreekargahenteghalghodrat.xml";
        const string XMLDOCFILEPATHREE = "fatreetecnolojishasibadane.xml";
        XDocument doc;

        public famecanicthree()
        {
            InitializeComponent();
        }

        private void famecanicthree_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
