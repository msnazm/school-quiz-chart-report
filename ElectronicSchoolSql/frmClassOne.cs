...
{
    public partial class frmClassOne : Form
    {
        const string XMLDOCFILEPATGHORAN = "dbgh.xml";
        const string XMLDOCFILEPATR = "dbr.xml";
        const string XMLDOCFILEPATO = "dbo.xml";
        const string XMLDOCFILEPATB = "dbb.xml";
        XDocument doc;
        ...
        private void frmClassOne_Load(object sender, EventArgs e)
        {
            ...
            //axShockwaveFlash1.Parent = this.pictureBox1;
