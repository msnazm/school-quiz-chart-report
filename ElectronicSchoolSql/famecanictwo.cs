...
{
    public partial class famecanictwo : Form
    {
        const string XMLDOCFILEPAONE = "famecanickhodrotwocaromomi.xml";
        const string XMLDOCFILEPATWO = "fatecnolojimavaledeghorat.xml";
        ...
        private void famecanictwo_Load(object sender, EventArgs e)
        {
            RefreshDone();
        }
